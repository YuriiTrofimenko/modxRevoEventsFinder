<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Медальерное искусство',
    'longtitle' => '',
    'description' => '',
    'alias' => 'medal-ernoe-iskusstvo',
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    'unpub_date' => 0,
    ...
    'content' => 'Около 700 экспонатов содержится в фонде музея медальерного искусства Е. В. Харабета. Здесь вы познакомитесь с завершёнными медалями, эскизами в керамике, фотографиями, даже куском обшивки космического корабля «Буран» с медалью работы Е. Харабета, посвященной запуску. Есть уникальные произведения, не выставлявшиеся нигде более, потому что они хранились в мастерской медальера.',
    'richtext' => 1,
    'template' => 3,
    'menuindex' => 0,
    'searchable' => 1,
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1524734940,
    'editedby' => 1,
    'editedon' => 1524734985,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1524734985,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    'context_key' => 'web',
    'content_type' => 1,
    'uri' => 'events/75-medal-ernoe-iskusstvo',
    'uri_override' => 1,
    ...
    array (
      0 => 'img',
      1 => 'assets/uploads/medal-ernoe-iskusstvo.jpg',
      2 => 'text',
      3 => NULL,
      4 => 'image',
    ),
...
<a href="/events/75-medal-ernoe-iskusstvo/#_" class="lightbox" id="lightbox">
	<img src="assets/uploads/medal-ernoe-iskusstvo.jpg">
</a>
<div class="container">
	<h4>
    ...
    <div class="row">
    	<div class="col s4 m4 l4 xl4">
	        <div class="card">
		        <div class="card-image">
		        	<a href="/events/75-medal-ernoe-iskusstvo/#lightbox">
				  		<img src="/assets/components/phpthumbof/cache/medal-ernoe-iskusstvo.d9ffc2ce066f23b69f2b31c839306ac175.jpg">
					</a>
		        </div>
        ...
        <div class="col s8 m8 l8 xl8">
        	<div>Дата: 03.05.2018</div>
        	<hr>
        	<div>
        		<h6>Описание:</h6>
        		<p>Could not load snippet Jevix</p>
        	</div>
        </div>
    </div>
</div>
...
<html>
  ...
  <li  class="first"><a href="/" >Главная</a></li><li  class="active"><a href="events" >События</a></li><li  class="last"><a href="test" >Test</a></li>
    ...
    '[[$eventDetailsContent]]' => '<!-- lightbox container hidden with CSS -->
<a href="/events/75-medal-ernoe-iskusstvo/#_" class="lightbox" id="lightbox">
	<img src="assets/uploads/medal-ernoe-iskusstvo.jpg">
</a>
<div class="container">
    ...
    <div class="nav-wrapper container">
      ...
      array (
        ...
        array (
          ...
          'category' => 3,
          'cache_type' => 0,
          'snippet' => '<!-- lightbox container hidden with CSS -->
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col s8 m8 l8 xl8">
          ...
          'content' => '<!-- lightbox container hidden with CSS -->
<a href="[[++base_url]][[~[[*id]]]]/#_" class="lightbox" id="lightbox">
	<img src="[[*img]]">
</a>
<div class="container">
